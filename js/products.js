...
const PRODUCTS = [
  ...
  { id: 'yellow-buckle-mini-bag', name: 'Sunburst Buckle Mini Bag', cat: 'bags', price: 28000, rating: 4.7, reviews: 89, tags: ['new'], colors: ['#f2c230', '#111'], desc: 'A top-handle mini with a gold buckle flap. Room enough for phone, cards and lipstick.' },
  ...
  { id: 'adire-longline-shirt-set', name: 'Adire Longline Robe', cat: 'locally-made', price: 61000, rating: 4.6, reviews: 18, colors: ['#111', '#ffffff'], desc: 'Open-front longline robe in stamped adire, unisex and one size.' }
];
